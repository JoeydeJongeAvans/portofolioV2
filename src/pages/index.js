...
import profilePic from "../../public/images/profile/Joey.png";

export default function Home() {
  return (
    <>
      <Head>
        <title>Joey de Jonge</title>
        <meta
          name="description"
          content="Joey de Jonge | Implementation Specialist"
        />
      </Head>
          ...
          <div className="flex w-full items-start justify-between md:flex-col pt-10 pb-24">
            ...
            <div className="flex w-1/2 flex-col items-center self-center lg:w-full lg:text-center">
              ...
              <div className="flex w-1/2 w-full items-center items-start lg:w-full  lg:!justify-center  sm:!justify-center  md:!text-center md:inline-block md:w-full">
               ...
               Working at CM.com as Consultant.
                </h2>
              </div>

              <p className="my-4 text-base font-medium md:text-sm sm:!text-sm">
               I’m 26-year-old professional with a robust background in application development (MBO) and informatics (HBO). I am the founder of Vedr and currently serve as a Professional Service Consultant at CM.com. Driven by my passion for technology and innovation, I specialize in delivering creative, efficient solutions that propel business success.
              </p>
            ...
            md:p-2 md:px-4 md:text-base
             `}
                ...
                <Link
                  href="https://github.com/JoeydeJongeAvans?page=1&tab=repositories/"
                  target={"_self"}
